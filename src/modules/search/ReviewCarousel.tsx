...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    location: 'London, UK',
    rating: 5,
    text: 'The round-trip booking flow is seamless. Both outbound and return flights were confirmed on one screen. Prices are transparent — no hidden fees on checkout.',
    route: 'LHR → ARN',
    initials: 'AO',
